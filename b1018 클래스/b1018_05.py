...
print("길이 : ",c1.get_length()) #2. getter를 값출력
c1.set_length(200)               #3. setter를 값을입력
print("길이 변경: ",c1.get_length()) #4. getter를 값출력
c1.__length = 100                           #5. 변수 직접입력
print("직접 변경: ",c1.__length)               #6. 변수 직접출력
print("get으로 읽어온 length: ",c1.get_length()) #7. getter를 값출력
